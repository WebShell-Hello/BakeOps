...
export function MetricCard({ label, icon: Icon, tone, emptyLabel }: MetricCardProps) {
  return (
    <Card className="min-h-40 p-5 xl:p-6">
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 pt-0.5">
          ...
          <p className="mt-1.5 text-3xl font-semibold tracking-tight">—</p>
          <p className="mt-3 text-xs text-[var(--muted)]">{emptyLabel}</p>
        </div>
      </div>
    </Card>
  );
